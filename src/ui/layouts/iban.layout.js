/**
 * Layout declarativo para Robot IBAN en Salesianos Urnieta
 * Define la estructura de tabs, grupos y widgets específicos para el robot IBAN
 */

export const IBAN_LAYOUT = {
  tabs: [
    {
      id: "principal",
      label: "Principal",
      ...
      groups: [
        ...
        },
        {
          ...
          widgets: [
            { type: "camera", label: "CAM_01_IBAN", path: "camera.stream" }
          ]
        }
      ]
    },
